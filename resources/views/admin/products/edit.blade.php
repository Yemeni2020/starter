                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
                            ...
                            <div class="mt-3 grid gap-4">
                                <flux:input name="meta_title" label="{{ __('Meta title') }}" value="{{ old('meta_title', $product->meta_title) }}" />
                                <flux:textarea name="meta_description" label="{{ __('Meta description') }}" rows="3">{{ old('meta_description', $product->meta_description) }}</flux:textarea>
                                <flux:input name="canonical_url" label="{{ __('Canonical URL') }}" type="url" value="{{ old('canonical_url', $product->canonical_url) }}" />
                            </div>
                        </div>
